...
import com.julygt.ProyectoFinalUTEC.auth.JwtAuthenticationFilter;
import com.julygt.ProyectoFinalUTEC.auth.JwtService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtService jwtService, UserDetailsService userDetailsService) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // Rutas públicas
                        .requestMatchers("/api/auth/**").permitAll()   //requestMatchers despues de /** (todo_se_permitido)
                        ...
                        .anyRequest().authenticated()  // esto es seguridad
                )
    ...
    // Esto nos puede servir para el front
    @Bean
    ...
    // BCryptPasswordEncoder proceso de encriptacion
    @Bean
